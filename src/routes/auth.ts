...
import { initiateGoogleAuth, handleGoogleCallback, handleGoogleCallbackPopup, exchangeGoogleCode, refreshAuthToken, getDebugToken, logout } from "../controller/googleOAuthController.js";
...
router.post("/logout", logout);                     // Clear session cookies (frontend calls this on sign-out)
